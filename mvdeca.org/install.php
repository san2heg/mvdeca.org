...
<?php
 if(isset($_POST['submit']))
  {
	 mysql_connect($_POST['dbHostName'], $_POST['dbUser'], $_POST['dbPassword']) or die("CANNOT CONNECT TO DB");
	 mysql_select_db($_POST['dbName']) or die("CANNOT SELECT DB");
	 ...
	 field_21 TEXT ,
	 field_22 TEXT ,
	 field_23 TEXT )") or die("Error! Table not be created.");
