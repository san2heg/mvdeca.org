<?php
	...
	if ($_SESSION['signedin'] != "YES") {
		...
		echo "
			...
			";
			if ($_SESSION['isOctagonMember'] != "YES") {
			echo"
				<body onLoad=\"collapseAll()\" style=\"min-height: 800px\">
			";
			}
			else {
			echo "
		...
		echo "
		    ...
		    <div class = \"container\">
		      ...
		      <section id=\"header-slide\" style=\"  background: url(img/signin.jpg) 50% 0 repeat fixed; background-size: auto 750px;\" data-type=\"background\" data-speed=\"6\">
		        <h2 class = \"header-slide-text\"style = \"width: 550px\">VOLUNTEERING</h2>
		      </section>
		      <div id = 'destination1' class = 'subhead'>EVENTS</div>
		      <hr/>
		      	";
		      	if ($_SESSION['isOctagonMember'] != "YES") {
		      	echo"
			    <div style = 'margin: 0 auto; text-align:center; color:black; width: 500px; font-size: 17px'>
			    	It looks like you haven't signed up to be an Octagon Member. Please <a href='http://mvoctagon.com/join.php'>click here</a> to sign up as an official Octagon Member <span style='color:red;'>(with the same email as your MVDECA account)</span> and gain access to exclusive MVDECA volunteering events.<br><br>
			    </div>";
			    }
			    else {
			    echo"
