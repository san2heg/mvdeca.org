	...
	if ($_SESSION['signedin'] != "YES") {
		...
		echo "
		    ...
		    <div class = \"container\" style = \"height: 1800px\">
		      ...
		      <div id = 'destination1' class = 'subhead'>SVCDC CONFIRMATION</div>
		      <hr/>
		      ";
		      
		      //if ($_SESSION['verified'] == "") {
			    echo"
			  <div style='text-align:center; font-size: 15px; color:red'>Please read over the information below, fill out the registration fields, and confirm that you are attending SVCDC.</div>
			  <br>
			  <div style='width: 550px; margin: 0 auto; text-align:left; font-size: 20px;'><span style='font-weight: 700'>NAME:</span> Silicon Valley Career Development Conference</div>
			  <div style='width: 550px; margin: 0 auto; text-align:left; font-size: 20px;'><span style='font-weight: 700'>DATES:</span> Friday, January 2 - Sunday, January 4</div>
			  <div style='width: 550px; margin: 0 auto; text-align:left; font-size: 20px;'><span style='font-weight: 700'>PLACE:</span> San Jose Marriott</div>
			  <div style='width: 550px; margin: 0 auto; text-align:left; font-size: 20px;'><span style='font-weight: 700'>PRICE:</span> $260 (housing inclusive)</div><br>
			  <hr>
			  
			<form method=post action=svcdc-process.php onSubmit=\"return validateUser();\">
			  	...
			  	<div>
			  		<table>
			  			<tr class = 'signin-row'>
			  				...
			  				<td style = 'padding-right: 20px' class = 'signin-table'><input style='width: 300px;'value = \"\" type = \"text\" name = \"svcdc_room1\" id=\"svcdc_room1\" placeholder=\"First and Last Name\"></td>
			  			</tr>
			  			<tr class = 'signin-row'>
			  				<td style = 'padding-left: 20px;' class = 'signin-table'>Roommate #2</td>
			  				<td style = 'padding-right: 20px' class = 'signin-table'><input style='width: 300px;'value = \"\" type = \"text\" name = \"svcdc_room2\" id=\"svcdc_room2\" placeholder=\"First and Last Name\"></td>
			  			</tr>
			  			<tr class = 'signin-row'>
			  				<td style = 'padding-left: 20px;' class = 'signin-table'>Roommate #3</td>
			  				<td style = 'padding-right: 20px' class = 'signin-table'><input style='width: 300px;'value = \"\" type = \"text\" name = \"svcdc_room3\" id=\"svcdc_room3\" placeholder=\"First and Last Name\"></td>
			  			</tr>
			  		</table>
			  	</div>
			  </div>
...
<select style='width:100%'name='cell_carrier' id='cell_carrier'>
  ...
  <option value=\"Boost\">Boost</option>
			  			...
			  			<tr class = 'signin-row'>
			  				...
			  				<td style = 'padding-right: 20px' class = 'signin-table'>
<select style='width:100%'name='svcdc_updates' id='svcdc_updates'>
  ...
  <option value=0>No</option>
		...
		<!--
			...
			{
				retVal = true;
if (validateField('roleplay','written', 'role_partner', 'cellphone', 'cell_carrier', 'svcdc_updates') == false)
 retVal=false;
				if(retVal == false)
				{
