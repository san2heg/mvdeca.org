    ...
    <div class = "container">
      ...
      <section id="header-slide" style="  background: url(img/signin.jpg) 50% 0 repeat fixed; background-size: auto 750px;" data-type="background" data-speed="6">
        <h2 class = "header-slide-text"style = "width: 300px">SIGN IN</h2>
      </section>

	<form method=post action=account-process.php onSubmit="return validateUser();">
	  ...
	  <div class = "signin-box">
	  	<div>
	  		<table>
	  			<tr class = 'signin-row'>
	  				...
	  				<td style = 'padding-right: 20px' class = 'signin-table'><input value = "" type = "text" name = "signin-email" id="signin-email" placeholder="Email"></td>
	  			</tr>
	  			<tr class = 'signin-row'>
	  				<td style = 'padding-left: 20px' class = 'signin-table'>PASSWORD</td>
	  				<td style = 'padding-right: 20px' class = 'signin-table'><input value = "" type = "password" name = "signin-pass" id = "signin-pass" placeholder="Password"></td>
	  			</tr>
	  		</table>
	  	</div>
	  		  		<br>
	  	...
	  	<div style = "width: 178px; margin: 0 auto;">
	  		...
	  		<a href = "registration.php" class = "btn btn-primary">JOIN NOW</a>
	  		<br><br><br>
	  	</div>
	  	<hr class = "signin-divider">
	  	<div style = "width: 178px; margin: 0 auto; margin-bottom: -8px;">
...
<SCRIPT type=text/javascript>
		<!--
			...
			{
				retVal = true;
if (validateField('signin-email','text') == false)
 retVal=false;
if (validateField('signin-pass','text') == false)
 retVal=false;
				if(retVal == false)
				{
